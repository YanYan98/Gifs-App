export interface SearchGifsRespond {
    data:       Gif[];
...
export class Convert {
    public static toSearchGifsRespond(json: string): SearchGifsRespond {
        return cast(JSON.parse(json), r("SearchGifsRespond"));
    }

    public static searchGifsRespondToJson(value: SearchGifsRespond): string {
        return JSON.stringify(uncast(value, r("SearchGifsRespond")), null, 2);
    }
}
